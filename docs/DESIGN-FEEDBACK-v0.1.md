# Holoverse Design Feedback (v0.1)
...
*   **Critique:** If players spend time as NPCs in another user's universe, their reward mechanism is unclear.
*   **Question:** Does the reward come from the Epoch Cap, or does the Universe Owner pay them from their own earnings?

### C. Evolution Mechanics: Deterministic vs. Generative
*   **Issue:** The doc doesn't specify if evolution is a choice or a random roll.
*   **Critique:** Purely generative evolution can frustrate players burning capital for "bad" outcomes. Purely deterministic evolution leads to "meta-gaming" where everyone picks the same "optimal" path.
*   **Suggestion:** Use a "Hybrid Choice" model: Players choose a general direction (e.g., "Technological"), but the specific traits/visuals are generative.

### D. The Pro-Cyclical "Adaptive Rule"
*   **Issue:** Emissions scale down when burns are low.
*   **Critique:** This can create a "liquidity black hole." Low interest -> Low rewards -> Even lower interest.
*   **Suggestion:** Implement a floor for emissions or a counter-cyclical reserve to maintain baseline activity during market downturns.
